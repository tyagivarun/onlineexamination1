...
//public class onlineexaminationEx {
//
//}
import javax.swing.*;  
import java.awt.*;  
...
{  
    ...
    {  
        ...
        if(current==0)  
        {  
            l.setText("1: How many colour in rainbow?");  
            jb[0].setText("3");jb[1].setText("6");jb[2].setText("7");jb[3].setText("9");   
        }  
        if(current==1)  
        {  
            l.setText("2: How manys days in 2 month?");  
            jb[0].setText("61");jb[1].setText("98");jb[2].setText("67");jb[3].setText("56");  
        }  
        if(current==2)  
        {  
